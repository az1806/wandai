		...
		<li><a>产品搜索</a>
			<ul id="pro-search">
				<li><a><input type="text" class="pro-search"><a
						class="pro-search-btn">搜索</a>
				</a>
				</li>
			</ul></li>
		<li><a>产品分类</a>
			<ul id="pro-category">
			<%List<ProductList> p=(List<ProductList>) request.getAttribute("product");
			for(int i=0;i<p.size();i++){ %>
			<li class="on"><a href="#"><%=p.get(i).getProductclass() %></a>
				</li>
			<%} %>

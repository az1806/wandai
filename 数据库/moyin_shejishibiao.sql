...
--
-- Table structure for table `shejishibiao`
--
...
--
-- Dumping data for table `shejishibiao`
--

LOCK TABLES `shejishibiao` WRITE;
/*!40000 ALTER TABLE `shejishibiao` DISABLE KEYS */;
INSERT INTO `shejishibiao` VALUES (1,'杰克','无');
/*!40000 ALTER TABLE `shejishibiao` ENABLE KEYS */;
UNLOCK TABLES;

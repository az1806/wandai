...
--
-- Table structure for table `guanliyuanbiao`
--
...
--
-- Dumping data for table `guanliyuanbiao`
--

LOCK TABLES `guanliyuanbiao` WRITE;
/*!40000 ALTER TABLE `guanliyuanbiao` DISABLE KEYS */;
INSERT INTO `guanliyuanbiao` VALUES (1,'张','123');
/*!40000 ALTER TABLE `guanliyuanbiao` ENABLE KEYS */;
UNLOCK TABLES;

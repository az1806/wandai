...
--
-- Table structure for table `liuyanbanbiao`
--
...
CREATE TABLE `liuyanbanbiao` (
  ...
  `LiuYanXinXi` varchar(45) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
...
--
-- Dumping data for table `liuyanbanbiao`
--

LOCK TABLES `liuyanbanbiao` WRITE;
/*!40000 ALTER TABLE `liuyanbanbiao` DISABLE KEYS */;
INSERT INTO `liuyanbanbiao` VALUES (1,'一楼','无','沙发','未回复',NULL);
/*!40000 ALTER TABLE `liuyanbanbiao` ENABLE KEYS */;
UNLOCK TABLES;
